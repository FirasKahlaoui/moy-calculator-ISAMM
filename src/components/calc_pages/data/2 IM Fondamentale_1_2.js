export const data = {
  regmix: {
    ...
    subjects: [
      ...
      { name: "Tests de logiciels [Certification ISTQB] (1)", coef: 1, grades: [] },
      { name: "Analyse Numérique (1.5)", coef: 1.5, grades: [] },
      { name: "Circuits logiques programmables (1.5)", coef: 1.5, grades: [] },
    ],
  },
  cc: {
    name: "cc",
